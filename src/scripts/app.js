...
function documentReady() {
  ...
  $('pre code').each(function(i, block) {
    ...
    $(this).parent().append('<button class="copy-button" data-clipboard-text="'+codeText+'"><p class="copy"><i class="fa fa-lg fa-paperclip" aria-hidden="true"></i>&nbsp;&nbsp;Copy</p><p class="copied"><i class="fa fa-lg fa-check" aria-hidden="true"></i>&nbsp;&nbsp;Copied to clipboard</p></button>');
    var heightOfCodeblock = $(this).height();
    if (heightOfCodeblock > 325) {
      $(this).height(365);
      $(this).css('overflow-y', 'hidden');
      $(this).parent().append('<button class="expand-code-block-button"><p>Read more</p></button>');
    }
  });

  $('.expand-code-block-button').click(function() {
    var codeBlock = $(this).closest('pre').find('code')
      if(codeBlock.height() > 446) {
        codeBlock.height(365);
